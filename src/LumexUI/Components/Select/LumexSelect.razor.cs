...
public partial class LumexSelect<TValue> : LumexInputBase<TValue>, ISlotComponent<SelectSlots>
{
	...
	private readonly Memoizer<SelectSlots> _slotsMemo;
	private readonly Memoizer<PopoverSlots> _popoverSlotsMemo;
	private readonly Memoizer<ListboxSlots> _listboxSlotsMemo;
	...
	public LumexSelect()
	{
		...
		_slotsMemo = new Memoizer<SelectSlots>();
		_popoverSlotsMemo = new Memoizer<PopoverSlots>();
		_listboxSlotsMemo = new Memoizer<ListboxSlots>();
	...
	protected override void OnParametersSet()
	{
		...
		_slots = _slotsMemo.Memoize( GetSlots, [
			LabelPlacement,
			FullWidth,
			Required,
			Disabled,
		...
		// Perform a re-building only if the dependencies have changed
		_popoverSlots = _popoverSlotsMemo.Memoize( GetPopoverSlots, [
		...
		// Perform a re-building only if the dependencies have changed
		_listboxSlots = _listboxSlotsMemo.Memoize( GetListboxSlots, [
			_slots.Listbox,
			Classes?.Listbox,
			ListboxClasses
		] );
