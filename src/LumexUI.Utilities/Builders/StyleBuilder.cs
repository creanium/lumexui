...
public struct StyleBuilder
{
	...
	/// <param name="when">Condition in which the style is added.</param>
	/// <returns>StyleBuilder</returns>
	public StyleBuilder AddStyle( string prop, string value, Func<bool> when = null! ) => AddStyle( prop, value, when() );
	...
	/// <param name="when">Condition in which the style is added.</param>
	/// <returns>StyleBuilder</returns>
	public StyleBuilder AddStyle( string prop, Func<string> value, Func<bool> when = null! ) => AddStyle( prop, value(), when() );
	...
	/// <returns>StyleBuilder</returns>
	public StyleBuilder AddStyle( StyleBuilder builder, Func<bool> when = null! ) => AddStyle( builder, when() );
	...
	public StyleBuilder AddStyleFromAttributes( IReadOnlyDictionary<string, object> additionalAttributes ) =>
		...
		additionalAttributes.TryGetValue( "style", out object? c ) ? AddRaw( c.ToString()! ) : this;
