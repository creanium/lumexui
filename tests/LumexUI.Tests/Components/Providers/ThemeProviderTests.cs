...
public class ThemeProviderTests : TestContext
{
    ...
    public void ThemeProvider_DifferentCultures_ShouldRenderCorrectly( string cultureName )
    {
        ...
        var expectedCssVars = new StringBuilder().AppendJoin( "\n",
            ...
            "--lumex-font-sans: ;",
            "--lumex-font-mono: ;",
            "--lumex-font-size-xs: .75rem;",
            "--lumex-font-size-sm: .875rem;",
            "--lumex-font-size-md: 1rem;",
            "--lumex-font-size-lg: 1.125rem;",
            "--lumex-line-height-xs: 1rem;",
            "--lumex-line-height-sm: 1.25rem;",
            "--lumex-line-height-md: 1.5rem;",
            "--lumex-line-height-lg: 1.75rem;",
