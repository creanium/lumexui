...
public class ThemeProviderTests : TestContext
{
    ...
    public void ThemeProvider_DifferentCultures_ShouldRenderCorrectly( string cultureName )
    {
        ...
        var expectedCssVars = new StringBuilder().AppendJoin( "\n",
            ...
            "--lumex-divider: 0 0% 0%;",
            "--lumex-content1: 0 0% 100%;",
            "--lumex-content1-foreground: 240 10% 4%;",
            "--lumex-content2: 240 5% 96%;",
            "--lumex-content2-foreground: 240 6% 10%;",
            "--lumex-content3: 240 6% 90%;",
            "--lumex-content3-foreground: 240 4% 16%;",
