...
public class ThemeProviderTests : TestContext
{
    ...
    public void ThemeProvider_DifferentCultures_ShouldRenderCorrectly( string cultureName )
    {
        ...
        var expectedCssVars = new StringBuilder().AppendJoin( "\n",
            ...
            "--lumex-content1: 0 0% 98.04%;",
            "--lumex-content1-foreground: 240 5.26% 26.08%;",
            "--lumex-content2: 240 4.76% 95.88%;",
            "--lumex-content2-foreground: 240 3.7% 15.88%;",
            "--lumex-content3: 240 5.88% 90%;",
            "--lumex-content3-foreground: 240 5.26% 26.08%;",
